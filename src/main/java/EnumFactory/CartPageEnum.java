...
public enum CartPageEnum {
    ...
    XPATH_RELATED_PRODUCT_SECTION_LEFT_SLIDER("//*[@id='recommended-product']//*[@class='slick-arrow slick-prev slick-disabled']"),
    XPATH_RELATED_PRODUCT_SECTION_RIGHT_SLIDER("//*[@id='recommended-product']//*[@class='slick-arrow slick-next']"),
